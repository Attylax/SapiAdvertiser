...
*/
    ...
    private Post createPost(){
        Post post = new Post(title.getText().toString(), "Attila", "1", description.getText().toString(), shortDescription.getText().toString(), date.getText().toString(), place.getText().toString(), time.getText().toString(), Double.parseDouble(price.getText().toString()), imagesPath);
        Gson gson = new Gson();
